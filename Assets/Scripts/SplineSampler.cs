...
public class SplineSampler : MonoBehaviour
{
    ...
    private void OnDrawGizmosSelected()
    {
        ...
        for(int p =0; p < m_splineContainer.Splines.Count; p++)
        {
            Handles.SphereHandleCap(p, m_splineContainer.Spline.ElementAt(p).Position, Quaternion.identity, 5f, EventType.Repaint);
