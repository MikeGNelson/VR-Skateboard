...
*/
    ...
    //        Vector3 p3 = (m_vertsP1[i] + m_vertsP2[i]) / 2f ;

    //        Handles.matrix = transform.localToWorldMatrix;
    //        Handles.SphereHandleCap(0, p1, Quaternion.identity, .2f, EventType.Repaint);
    //        Handles.SphereHandleCap(0 + m_vertsP1.Count, p2, Quaternion.identity, .2f, EventType.Repaint);
    //        Handles.SphereHandleCap(0 + m_vertsP1.Count *2, p3, Quaternion.identity, 1f, EventType.Repaint);
    //    }
